  ...
  Future<void> _showInterest() async {
    ...
    if (room != null && currentUserId != null && room.userId != currentUserId) {
      try {
        ...
        debugPrint('Creating room interest notification:');
        debugPrint('- Room Owner ID: ${room.userId}');
        ...
        // Refresh notifications for the room owner
        await notificationCubit.getNotifications(room.userId);
